...
import 'package:photo_sharing_clone_app/owner_details/owner_details.dart';
import 'package:photo_sharing_clone_app/profile_screen/profile_screen.dart';
import 'package:photo_sharing_clone_app/search_post/search_post.dart';
    ...
    return Container(
      ...
      child: Scaffold(
        ...
        body: StreamBuilder<QuerySnapshot>(
          stream: FirebaseFirestore.instance.collection('wallpaper').orderBy("createdAt", descending: false).snapshots(),
